...
<p>estamos en gato</p>
    <section class="container second__container">
        ...
        <a  class="close"></a>
            <a class="headerTitle__link" href="<?=URL."/admin/sessionClose"?>"><img src="<?=URL?>/assets/images/btn-close.svg" alt=""></a>
            <h1>Buscar</h1>
        </div>
        ...
        <div class="category">
            <a href="<?=URL?>/user" class="category__animal">
                <img class="category__animal--image" src="<?=URL?>/assets/images/fa-solid_dog.svg" alt="">
                <p class="category__animal--text">Perros</p>
            </a>
            <a href="<?=URL?>/user/gato" class="category__animal category__animal--mod">
                <img class="category__animal--image" src="<?=URL?>/assets/images/fa-solid_cat.svg" alt="">
            ...
            ?>
                    ...
                    <a href="<?=URL."/user/details/".$value["id"]?>" class="a">
                            <div class="animal__photo">
                                <img class="animal__photo--image" src="<?=URL."/". $value["photo"] ?>" alt="">
                            </div>
